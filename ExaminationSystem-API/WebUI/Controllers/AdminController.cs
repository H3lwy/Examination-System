...
namespace WebUI.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public AdminController(AppDbContext Db, UserManager<User> UserManager, IHubContext<AdminHub> hubContext)
        {
            _Db = Db;
        ...
        public async Task<IActionResult> SendTestNotification()
        {
            ...
            await _hubContext.Clients.All.SendAsync("ReceiveNotification", "Test notification");

            // أو إرسال إشعار لمجموعة معينة
            await _hubContext.Clients.Group("AdminGroup").SendAsync("ReceiveNotification", "Test notification");
