    ...
    public partial class FirstTry : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentExamQuestionAnswerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentExamId = table.Column<int>(type: "int", nullable: false),
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentExamQuestionAnswers", x => x.StudentExamQuestionAnswerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExamQuestionAnswers_SelectedChoiceId",
                table: "StudentExamQuestionAnswers",
